  ...
  return (
    <main className="flex items-center justify-center">
      <div className="min-h-[800px] w-[800px] animate-pulse rounded-2xl bg-white p-7 shadow-md">
        <div className="skeleton-basic m-auto h-[322px] w-[300px]" />
        <div className="w-[100px]rounded-md mb-1 mt-7 h-7 bg-gray-200" />
        <div className="skeleton-basic my-2 h-6 w-[130px]" />
        <div className="skeleton-basic my-2 h-6 w-[100px]" />
        <div className="skeleton-basic h-[132px] w-full" />
        <div className="skeleton-basic mt-5 h-10 w-full" />
        <div className="skeleton-basic mt-3 h-[90px] w-full" />
        <div className="mt-3 flex h-12 w-full justify-end">
          <div className="skeleton-basic h-12 w-[87px]" />
        </div>
